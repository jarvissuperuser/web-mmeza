#!/usr/bin/env node
const parser = require('tree-sitter'); // import parser from 'tree-sitter';
const loader = require('tree-sitter-javascript'); // import loader from 'tree-sitter-javascript';
const hbs = require('handlebars');// import hbs from 'handlebars';
